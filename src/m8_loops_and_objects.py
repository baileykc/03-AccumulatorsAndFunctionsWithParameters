...
def draw_circles1():
    ...
    for k in range(20):
        radius = (10*k)
        circle1 = rg.Circle(rg.Point(200, 200), radius)
...
def draw_circles3():
    ...
    for k in range(101):
        radius = (k)
        circle1 = rg.Circle(rg.Point(200, 150), radius)
        circle1.attach_to(window)
        window.render()
    window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    for k in range(4):
        radius = (10)
        circle1 = rg.Circle(rg.Point(200 + 80 * math.cos(k), 200 + 80 * math.sin(k)), radius)
        circle1.attach_to(window)
        window.render()
    window.close_on_mouse_click()
